...
$requiredToken = '8ouOB6TZOuGeKUpt7JX9mc6IFaMZj0zpy57sKBq2AefojMAa2RfRZ4rfUgC2ji2U';
$requestMethod = $_SERVER['REQUEST_METHOD'] ?? '';
$providedToken = $_POST['token'] ?? '';

$isDefaultToken = $requiredToken === '8ouOB6TZOuGeKUpt7JX9mc6IFaMZj0zpy57sKBq2AefojMAa2RfRZ4rfUgC2ji2U';
$isAuthorized = !$isDefaultToken
    && $requestMethod === 'POST'
...
if (!$isAuthorized) {
    ...
    echo '403 Forbidden: setup requires POST and valid token.';
    exit;
}
...
echo "<p>One-time deploy endpoint (POST + token).</p>";
