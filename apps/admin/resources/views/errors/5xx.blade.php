...
<body>
    ...
    <div class="title">Ha fallado algo</div>
    <div class="divider"></div>
    <p class="message">Algo ha salido mal en nuestros servidores. Estamos trabajando para solucionarlo. Por favor, inténtalo más tarde.</p>
