...
<head>
    ...
    <title>PEQ Cakes | Pedido #{{ str_pad((string) $order->id, 5, '0', STR_PAD_LEFT) }} confirmado!</title>
</head>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:620px; background-color:#ffffff; border:1px solid #e5e7eb;">
                <tr>
                    <td align="center" style="padding:28px 24px 12px 24px; border-bottom:1px solid #e5e7eb;">
                        ...
                        <p style="margin:0; font-family:Arial, Helvetica, sans-serif; font-size:26px; line-height:1.2; color:#111827; font-weight:bold;">Pedido confirmado</p>
                        <p style="margin:10px 0 0 0; font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:1.5; color:#4b5563;">
                            ¡Hola {{ $order->customer_name }}!
                        </p>
                        <p style="margin:10px 0 0 0; font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:1.5; color:#4b5563;">
                            Hemos recibido el Bizum y tu pedido #{{ $orderNumber }} ya est&aacute; confirmado.
                        </p>
                        <p style="margin:10px 0 0 0; font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:1.5; color:#4b5563;">
                            Gracias por confiar en PEQ Cakes.
                        </p>
                    </td>
                </tr>
                            ...
                            <tr>
                                <td style="padding:12px;">
                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td style="padding:4px 0; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#6b7280;">Estado</td>
                                            <td style="padding:4px 0; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#059669; text-align:right;">Pagado</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                ...
                <tr>
                    <td style="padding:20px 24px 0 24px;">
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5e7eb;">
                            ...
                            @endif
                            <tr>
                                <td colspan="3" style="padding:12px 10px; font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#111827; font-weight:bold; text-align:right; border-top:1px solid #e5e7eb;">Total pagado</td>
